    ...
    return <footer className="border-gray-100 border-t">
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-no-wrap flex-wrap flex-col">
                ...
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    {/* Social Media */}
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3 uppercase">Social</h2>
                        <nav className="list-none mb-10">
                            <li className="my-6 md:my-3">
                                <a className="text-gray-600 hover:text-gray-800" target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/valkyriepcs_/">Instagram</a>
                            </li>
                        </nav>
                    </div>
                    {/* Contact */}
